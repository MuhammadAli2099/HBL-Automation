...
export class InitiateFinanceRequestPage {
  ...
  get referenceNumber2104d023b959(): Locator {
    return this.page.getByLabel(/Reference Number 2104D023B959/i).first();
  }

  get referenceNumber2104d023b9592(): Locator {
    return this.page.getByRole('presentation', { name: /Reference Number 2104D023B959/i }).first();
  }
  ...
  get statusPendingForApproval(): Locator {
    return this.page.getByLabel(/Status Pending for Approval/i).first();
  }

  get statusPendingForApproval2(): Locator {
    return this.page.getByRole('presentation', { name: /Status Pending for Approval/i }).first();
  }
