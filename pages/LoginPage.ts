...
export class LoginPage {
  ...
  constructor(page: Page) {
    ...
    this.usernameInput = page
      .locator('input[name="username"], input[id*="user"], input[placeholder*="User"], input[type="text"]')
      .first();

    this.passwordInput = page
      .locator('input[name="password"], input[type="password"], input[id*="pass"], input[placeholder*="Password"]')
      .first();
    ...
    this.loginErrorMessage = page
      .locator('text=/invalid|incorrect|failed|error|unable|unsuccessful/i')
      .first();
